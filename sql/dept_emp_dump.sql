...
insert into emp  values(   7788, 'SCOTT', 'ANALYST', 7566,   to_date('13-6-1987','dd-mm-yyyy'),   3000, null, 20  );
...
insert into emp  values(   7876, 'ADAMS', 'CLERK', 7788,   to_date('13-6-1987', 'dd-mm-yyyy'),   1100, null, 20  );
